...
async function main() {
  ...
  const chatCompletion = await groq.chat.completions.create({
    "messages": [
      ...
      {role: "user",name:"[🌴_Groq]", content: "[🌴_Groq]+[promptmodel]+[🤖_emojis.sh]+[[💬-speacker]!" },
    ...
    const outputFilePath = "job-🤖_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
